...
const Button = ({
    ...
    const variants = {
        primary: "bg-neon-cyan/5 text-neon-cyan border border-neon-cyan/50 hover:bg-neon-cyan/10 hover:shadow-neon hover:border-neon-cyan transition-all duration-300",
