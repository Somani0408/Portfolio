...
const CyberBackground = () => {
    ...
    return (
        <div className="fixed inset-0 z-[-50] overflow-hidden pointer-events-none bg-cyber-black">
            {/* Canvas for Animation */}
            <canvas ref={canvasRef} className="absolute inset-0 w-full h-full" />

            {/* Overlay Gradient for Fade-out/Depth */}
            <div className="absolute inset-0 bg-radial-gradient from-transparent to-cyber-black opacity-60" />
